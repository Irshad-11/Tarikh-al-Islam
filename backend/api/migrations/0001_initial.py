    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_year_ad', models.IntegerField()),
                ...
                ('visibility_rank', models.IntegerField(default=0)),
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected'), ('DELETION_REQUESTED', 'Deletion Requested'), ('DELETED', 'Deleted')], default='PENDING', max_length=30)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
